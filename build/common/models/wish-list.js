    ...
    if (ctx.isNewInstance) {
      ...
      try {
        if (ctx.instance.brandId === 1) {
          url.url = 'https://bmwmotorradshop.autogermana.com.co/lista-de-deseos'
        } else if (ctx.instance.brandId === 2) {
          url.url = 'https://bmwshop.autogermana.com.co/lista-de-deseos'
        } else if (ctx.instance.brandId === 3) {
          url.url = 'https://minishop.autogermana.com.co/lista-de-deseos'
        }
      } catch (error) {
        throw error
      }
